...
```{r warning=FALSE}
#Wells Note: IMPORTANT

#Missing numerous tables from above. Wells fixed. Always put in sequential order to see the gaps
...
#Wells note: Add this step so we can combine the two DFs later
...
employer_masterAugSept <- smartbind(occupation8_17, occupation8_24, occupation8_27, occupation8_31, occupation9_14, occupation9_3, occupation9_7, occupation9_9)
...
#This creates an industry db from Sept 28-Feb 1, 2021. 
```{r warning=FALSE}
