...
#Wells NOTE: We needed to keep the original company names and create a second cleaned company names column. need the dirty one and the clean one on the same df.
