...
author: "Mary Hennigan, Rob Wells, Katy Seiter, Abby Zimmardi and Rachell Sanchez-Smith" 
date: "4/19/2021"
output: pdf_document
---
...
```
#Revision: 8,921 cases total cases of infected employees in Arkansas workplaces. 
#Previous: 11,103, 9158 
...
occupation_month <- zzz %>% 
  ...
  mutate(pct_occup_positive = (total_cases/positive2))

occupation_month$pct_occup_positive <- formattable::percent(occupation_month$pct_occup_positive)

occupation_month <- occupation_month %>% 
  select(yearmon, cleaned_county, total_cases, positive2, pct_occup_positive) %>% 
  rename(Year_Month = yearmon, County = cleaned_county, Worker_Covid = total_cases, Community_Covid = positive2, Worker_Community_Pct = pct_occup_positive)
...
#--------------------------------------------------------------------------
#--------------------------------------------------------------------------
# Notes, code in progress below
# Also, main code for compiling the PDFs is below
#--------------------------------------------------------------------------
#--------------------------------------------------------------------------
